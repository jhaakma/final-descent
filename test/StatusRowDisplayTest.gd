...
func test_elemental_resistance_description() -> bool:
    ...
    var expected: String = "50% Fire damage reduction."
    var actual: String = fire_resistance.get_description()
    print("DEBUG: Actual fire resistance description: %s" % actual)
    return assert_equals(expected, actual, "Fire resistance should show '50% Fire damage reduction'")