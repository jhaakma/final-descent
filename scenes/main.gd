...
func show_title() -> void:
    _clear_layer()
    _reset_fade_overlay()
    var s: TitleScreen = load("res://screens/TitleScreen.tscn").instantiate()
...
func show_room() -> void:
    _clear_layer()
    var s: RoomScreen = load("res://screens/RoomScreen.tscn").instantiate()
    screen_layer.add_child(s)
...
func show_game_over() -> void:
    _clear_layer()
    var s: GameOverScreen = load("res://screens/GameOverScreen.tscn").instantiate()
    screen_layer.add_child(s)
