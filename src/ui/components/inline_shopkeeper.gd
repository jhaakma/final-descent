class_name InlineShopkeeper extends InlineContentBase

## Inline shopkeeper component that replaces ShopkeeperPopup
## Displays shop interface directly in the room container
...
static func get_scene() -> PackedScene:
    return load("uid://d8qke7xfdy2nb") as PackedScene  # Will need to create this scene
...
func show_content() -> void:
    super.show_content()
    # Refresh the shop display when shown
    _update()
